...
class KITTIRAWDatasetCorres(KITTIDataset):
    ...
    def __init__(self, data_path, filenames, correspondences, height, width, frame_idxs,
        ...
        super(KITTIRAWDatasetCorres, self).__init__(data_path, filenames, height, width, frame_idxs,
                 num_scales, is_train=False, img_ext=img_ext)
