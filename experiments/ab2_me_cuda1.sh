# CUDA_VISIBLE_DEVICES=1 python train.py --model_name ab2_cuda1/c3vd_monodepth2_b8e30_me --data_path rect_c3vd_data \
...
CUDA_VISIBLE_DEVICES=1 python train_v2.py --model_name ab2_cuda1/c3vd_litemono_b8e35_me --data_path rect_c3vd_data \
  --dataset c3vd --split c3vd --batch_size 8 --height 256 --width 320 --png  --use_cudnn \
