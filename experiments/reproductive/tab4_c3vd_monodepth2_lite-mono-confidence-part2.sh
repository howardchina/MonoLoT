...
CUDA_VISIBLE_DEVICES=1 python train_corres.py --model lite-mono --model_name reproductive/tab4_c3vd/c3vd_lite-mono_b16e40_me_conf_0.9 --data_path rect_c3vd_data \
