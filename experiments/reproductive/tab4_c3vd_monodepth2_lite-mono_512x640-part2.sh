# CUDA_VISIBLE_DEVICES=1 python train_corres.py --model monodepth2 --model_name reproductive/tab4_c3vd/c3vd_monodepth2_b12e40_raw_HD --data_path rect_c3vd_data \
...
CUDA_VISIBLE_DEVICES=1 python train_corres.py --model monodepth2 --model_name reproductive/tab4_c3vd/c3vd_monodepth2_b8e40_raw_HD --data_path rect_c3vd_data \
