CUDA_VISIBLE_DEVICES=0 python train.py --model_name tab3_cuda0/kitti_monodepth2_b12e20 --data_path kitti_data_standard \
...
CUDA_VISIBLE_DEVICES=0 python train.py --model_name tab3_cuda0/kitti_monodepth2_b12e20_me --data_path kitti_data_standard \
